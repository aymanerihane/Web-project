        ...
        <form style="width:100%;" class="formSign" method="POST" action="{{ route('demandes')}}" id="demandeForm">
                <div style="display: flex;flex-direction:column;justify-content: space-between;align-items: center;">
                    ...
                    <input type="text" required name="object" style="margin-bottom: 10px">
                        <label class="labelf">
                            <span style="transition-delay:0ms">O</span><span style="transition-delay:50ms">B</span><span style="transition-delay:100ms">J</span><span style="transition-delay:150ms">E</span><span style="transition-delay:200ms">T</span>
                        </label>

                    </div> --}}

                    <textarea class="textarea" name="discDem" cols="30" rows="10"></textarea>
