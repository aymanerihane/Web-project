...
<div class="choixMode">
                    ...
                    $idfor = $_GET['formation'];
                    $filieres = app('App\Http\Controllers\filieres')->findfilfor($idfor);
                     }
                    @endphp
                    @if($filieres->count() > 0)
