    ...
    <div class="conatinerAd">
            <div id="nav-bar">
                ...
                <div id="nav-content">
                    ...
                    <hr class="hr"/>
                    <div class="nav-button btn4"><span>Ajouter et modifier le contenu d'une filière</span></div>
                    <div class="nav-button btn5"><span>Ajouter Membres</span></div>
                    <div class="nav-button btn6"><span>Ajouter Classe</span></div>
                    <div class="nav-button btn6"><span>Ajouter Filiere</span></div>
                    <div class="nav-button btn6"><span>Ajouter Module</span></div>
