...
<div class="choixMode">
                    ...
                    @if($filieres->count() > 0)
                        @foreach ($filieres as $filiere)
                            <div class="optionsMode filierech {{ $filiere->nom }}" data-id="{{ $filiere->id_filiere }}">
