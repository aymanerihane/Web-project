@vite(["resources/css/demande.css",'resources/css/profCard.css','resources/js/cardprof.js'])
...
<div class="body">
    ...
    <div class="espaceRPDEM" >
        ...
        <form id="mesform" method="POST" style=" width: 100%;">
        <div class="formulaireRepondre" style="display: flex;flex-direction:column">
            <div style="display: flex">
                <h1 style="margin:30px 0 0 30px;">Reponse</h1>
                <div class="radio-inputs" style="width: 100%">
                    <label>
                        <input class="radio-input" name="etat" type="radio" id="matcProf" value="Rejetée" required>
                        <span class="radio-tile">
                                <span class="radio-icon">
                                </span>
                                <span class="radio-label">Rejetée</span>
                            </span>
                        </label>
                    </div>
                ...
                <div class="radio-inputs" style="width: 100%">
                    <label>
                        <input class="radio-input" name="etat" type="radio" id="matcProf" value="Approuvée" required>
                        <span class="radio-tile">
                                <span class="radio-icon">
                                </span>
                                <span class="radio-label">Approuvée</span>
                            </span>
                        </label>
                    </div>
